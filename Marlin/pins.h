...
#ifdef RA_CONTROL_PANEL //look for RAPANEL in original

  #define SDSS             53
  #define SDCARDDETECT     28

  #define BTN_EN1          14	// EN1 and EN2 swap in original
  #define BTN_EN2          39
  #define BTN_ENC          15  //the clicker
